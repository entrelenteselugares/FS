      ...
      >
        <div className="flex items-center gap-4 md:gap-6">
          ...
          <div className="text-left space-y-1">
            <div className="text-lg font-heading font-black text-theme-text uppercase tracking-tighter italic leading-tight">Venda Rápida Foto Segundo</div>
            <div className="text-[10px] font-black text-theme-muted uppercase tracking-[0.2em] italic">Registre o recebimento e libere o acesso na hora</div>
          </div>
        </div>
