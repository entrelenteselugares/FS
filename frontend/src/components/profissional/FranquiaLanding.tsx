...
export function FranquiaLanding() {
  ...
  return (
    <div className="space-y-16 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      {/* Header Visual */}
      <div className="relative h-[400px] bg-zinc-950 border border-theme-border overflow-hidden group">
        ...
        <div className="relative z-20 h-full flex flex-col justify-center px-12 md:px-20 space-y-6">
          <div className="inline-flex items-center gap-4 bg-brand-tactical text-black px-4 py-1 self-start">
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <button 
              ...
              className="px-8 py-4 bg-brand-tactical text-black font-display font-black text-xs uppercase tracking-widest hover:brightness-110 transition-all flex items-center gap-3 shadow-xl shadow-brand-tactical/20"
            >
              QUERO SER FRANQUIA <Rocket size={16} />
            </button>
            <button 
              onClick={() => setShowCalc(!showCalc)}
              className="px-8 py-4 border border-white/30 text-white font-display font-black text-xs uppercase tracking-widest hover:bg-white/5 transition-all flex items-center gap-3"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          ...
          <div key={idx} className="bg-theme-bg border border-theme-border p-10 space-y-6 hover:border-brand-tactical/30 transition-all">
      ...
      <AnimatePresence>
        {showCalc && (
          ...
          >
            <div className="bg-zinc-950 border border-brand-tactical/30 p-12 md:p-20 relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10">
                ...
                {/* Result Card */}
                <div className="bg-brand-tactical p-12 text-black flex flex-col justify-between">
                  <div className="space-y-8">
                  ...
                  <div className="space-y-6 border-t border-black/10 pt-8 mt-8">
                    ...
                    <button 
                      ...
                      className="w-full bg-black text-white py-4 font-display font-black text-[10px] uppercase tracking-widest hover:brightness-125 transition-all flex items-center justify-center gap-3"
                    >
      ...
      {/* CTA Final */}
      <div className="flex flex-col items-center text-center space-y-10 py-10 border-t border-theme-border">
        <div className="space-y-4">
          ...
          <p className="text-zinc-500 text-[10px] font-black uppercase tracking-[0.4em] max-w-xl mx-auto leading-relaxed">
            Nossa equipe entrará em contato para realizar uma análise de viabilidade na sua região.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <button
            ...
            className="px-12 py-5 bg-brand-tactical text-black font-display font-black text-[11px] uppercase tracking-widest hover:brightness-110 transition-all shadow-xl shadow-brand-tactical/20"
          >
          ...
          <button
            ...
            className="px-12 py-5 border border-theme-border text-zinc-400 font-display font-black text-[11px] uppercase tracking-widest hover:border-brand-tactical/40 hover:text-white transition-all flex items-center gap-3"
          >
