  ...
  return (
    <div className="bg-theme-bg-muted border-l-4 border-brand-tactical border-y border-r border-theme-border rounded-2xl p-4 md:p-6 flex flex-col md:flex-row items-center justify-between gap-6 overflow-hidden">
      <div className="space-y-1">
        <h4 className="text-[11px] font-bold text-brand-tactical uppercase tracking-[0.4em] ">Suporte de Campo</h4>
      ...
      <a
        ...
        className="w-full md:w-auto px-4 md:px-8 py-2.5 md:py-4 bg-brand-tactical text-brand-text text-[10px] font-bold uppercase tracking-[0.3em] flex items-center justify-center gap-2 hover:brightness-110 rounded-xl transition-all shadow-lg shadow-brand-tactical/10"
      >
