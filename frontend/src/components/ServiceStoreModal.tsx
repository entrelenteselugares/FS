            ...
            <div className="space-y-6">
              ...
              <div className="pt-4 border-t border-white/10 flex justify-end gap-3">
                 <button
                    ...
                    className="px-4 py-2 border border-white/10 rounded-lg text-xs font-black uppercase tracking-widest hover:bg-white/5 transition-colors"
                 >
                    Cancelar
                 </button>
                 <button
              ...
              {services.map((service) => (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="px-2 py-1 bg-white/5 text-zinc-300 text-[9px] font-black uppercase tracking-widest rounded">
