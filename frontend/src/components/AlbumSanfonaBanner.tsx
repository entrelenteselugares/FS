  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-theme-bg-muted to-theme-bg border border-brand-tactical/20 p-6 rounded-2xl mb-6 flex flex-col md:flex-row items-center justify-between gap-6 group hover:border-brand-tactical/50 transition-all duration-500">
      ...
      <button 
        ...
        className="relative z-10 w-full md:w-auto flex items-center justify-center gap-3 bg-brand-tactical text-brand-text px-8 py-3.5 rounded-xl text-[11px] font-bold uppercase tracking-[0.3em] hover:brightness-110 hover:shadow-[0_0_20px_rgba(133,185,172,0.3)] transition-all duration-300"
      >
