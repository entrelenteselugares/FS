    ...
    <div className="max-w-md mx-auto my-20 p-8 md:p-10 bg-theme-bg-muted border border-theme-border rounded-[30px] animate-in fade-in slide-in-from-bottom-8 duration-700">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
          ...
          className="w-full py-4 bg-brand-tactical text-brand-text font-bold uppercase tracking-[0.2em] text-[10px] rounded-xl hover:bg-brand-hover transition-all disabled:opacity-50 disabled:hover:bg-brand-tactical flex items-center justify-center gap-3 group"
        >
          Acessar Galeria
