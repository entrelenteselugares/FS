      ...
      <main className="pt-24 pb-20 px-3 md:px-6 md:px-12 max-w-3xl mx-auto">
        ...
        <section className="space-y-12">
          ...
          <div>
            ...
            <ul className="space-y-3 mb-6">
              {[
                ...
                <li key={i} className="flex items-start gap-3 text-theme-text-muted font-normal">
          ...
          <div>
            ...
            <div className="space-y-8">
              <div className="bg-theme-bg-muted p-3 md:p-6 md:p-8 rounded-2xl border border-theme-border">
                <h3 className="text-brand-tactical font-bold uppercase tracking-widest text-sm mb-3">Para quem quer contratar um profissional</h3>
                <p className="text-theme-text-muted font-normal leading-relaxed">Agende sua cobertura fotográfica em poucos cliques. Selecione uma unidade fixa autorizada ou solicite um orçamento personalizado, informe os detalhes do seu evento e garanta sua data com pagamento seguro via PIX — parcelado em até 2x. Receba sua galeria editada com qualidade editorial após o evento.</p>
              </div>

              <div className="bg-theme-bg-muted p-3 md:p-6 md:p-8 rounded-2xl border border-theme-border">
                <h3 className="text-brand-tactical font-bold uppercase tracking-widest text-sm mb-3">Para quem quer um álbum colaborativo</h3>
                <p className="text-theme-text-muted font-normal leading-relaxed">Crie um Cofre (Vault) privado para o seu evento, gere um link de convite e compartilhe com seus convidados. Cada um envia as fotos que tirou diretamente pela plataforma — sem compressão, sem perda de qualidade. A galeria se forma em tempo real, os convidados votam nas melhores poses, e você pode materializar as favoritas em impressões físicas entregues na sua casa.</p>
              </div>

              <div className="bg-theme-bg-muted p-3 md:p-6 md:p-8 rounded-2xl border border-theme-border">
                <h3 className="text-brand-tactical font-bold uppercase tracking-widest text-sm mb-3">Para profissionais de audiovisual</h3>
                <p className="text-theme-text-muted font-normal leading-relaxed">A Foto Segundo é a sua central de negócios. Gerencie sua agenda, receba leads qualificados, entregue seus trabalhos e acompanhe seus ganhos — tudo em um único painel. Sem depender de Instagram, sem negociar preço no WhatsApp.</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16 pt-12 border-t border-theme-border text-center">
            <h2 className="text-xl font-bold text-theme-text uppercase mb-6">Tem dúvidas ou quer ser parceiro?</h2>
