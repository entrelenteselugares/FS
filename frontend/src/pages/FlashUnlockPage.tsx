      ...
      <AnimatePresence mode="wait">
        {!unlocked ? (
          ...
          >
            ...
            <h1 className="text-3xl font-bold mb-2 tracking-tight uppercase italic">
          ...
          >
            ...
            <div className="w-full mt-8 space-y-4">
              ...
              <button 
                ...
                className="w-full py-4 bg-white/5 hover:bg-white/10 text-white font-bold rounded-xl transition-all flex items-center justify-center gap-3"
              >
