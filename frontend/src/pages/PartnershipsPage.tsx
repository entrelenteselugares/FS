      ...
      <main className="pt-32 pb-24 px-6 md:px-8 max-w-5xl mx-auto">
            ...
            {[
              ...
              <div key={idx} className="bg-theme-bg-muted border border-theme-border/40 p-8 rounded-2xl relative overflow-hidden group hover:border-brand-tactical/50 transition-colors">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-sm font-black uppercase tracking-widest mb-3">{s.t}</h3>
                  <p className="text-theme-text-muted text-sm font-light leading-relaxed">{s.d}</p>
                </div>
              </div>
            ))}
          </div>
            ...
            {[
              ...
              <div key={idx}>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="font-black uppercase tracking-widest text-sm">{v.t}</h3>
                </div>
        ...
        <section className="mb-24 border border-theme-border/60 bg-theme-bg-muted p-8 md:p-12 rounded-3xl relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl">
            <h2 className="text-2xl font-black uppercase italic tracking-tight mb-4 flex items-center gap-3">
