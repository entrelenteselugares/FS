          ...
          <form onSubmit={handleRegister} className="space-y-8">
            <div className="space-y-3">
              <button 
                ...
                className="w-full bg-theme-card text-theme-text hover:bg-theme-field border border-theme-border h-12 flex items-center justify-center relative rounded-2xl transition-all"
              >
