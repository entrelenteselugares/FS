...
export function LgpdPage() {
  return (
    <div className="min-h-screen bg-theme-bg text-theme-text font-sans selection:bg-brand-tactical/30">
      ...
      <main className="pt-32 pb-24 px-6 md:px-8 max-w-4xl mx-auto">
        ...
        <div className="space-y-16">
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div key={idx} className="border border-theme-border/40 p-6 rounded-xl hover:border-brand-tactical/30 transition-colors">
                  ...
                  <p className="text-sm text-theme-text-muted font-light leading-relaxed">{p.desc}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <section>
            ...
            <div className="bg-theme-bg-muted border border-theme-border/60 p-6 rounded-xl space-y-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="bg-theme-bg p-4 rounded-lg border border-theme-border/40">
          ...
          <section>
            ...
            <div className="border border-brand-tactical/30 bg-brand-tactical/5 p-8 rounded-xl flex flex-col sm:flex-row items-center gap-8">
          ...
          <section>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/privacidade" className="flex-1 flex items-center gap-4 bg-theme-bg-muted border border-theme-border/40 p-4 rounded-xl hover:border-brand-tactical/50 transition-all group">
              ...
              <Link to="/termos" className="flex-1 flex items-center gap-4 bg-theme-bg-muted border border-theme-border/40 p-4 rounded-xl hover:border-brand-tactical/50 transition-all group">
                <FileText className="text-theme-text-muted group-hover:text-brand-tactical transition-colors" size={24} />
                <div>
      ...
      <footer className="py-8 text-center border-t border-theme-border/20">
