      ...
      <main className="pt-32 pb-24 px-3 md:px-6 md:px-8 max-w-4xl mx-auto">
        ...
        <div className="space-y-12">
          ...
          <section className="scroll-mt-24" id="descrição-do-serviço">
            ...
            <p className="text-theme-text-muted text-sm md:text-base font-normal leading-relaxed mb-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-theme-bg-muted border border-theme-border p-5 rounded-xl">
                <h3 className="text-brand-tactical font-bold uppercase tracking-widest text-xs mb-2">Contratação Profissional</h3>
                <p className="text-theme-text-muted text-sm font-normal leading-relaxed">Agendamento de cobertura fotográfica com profissionais da rede</p>
              </div>
              <div className="bg-theme-bg-muted border border-theme-border p-5 rounded-xl">
                <h3 className="text-brand-tactical font-bold uppercase tracking-widest text-xs mb-2">Álbuns Colaborativos</h3>
                <p className="text-theme-text-muted text-sm font-normal leading-relaxed">Criação de cofres privados (Vaults) para upload e votação colaborativa de fotos entre convidados</p>
              </div>
              <div className="bg-theme-bg-muted border border-theme-border p-5 rounded-xl">
                <h3 className="text-brand-tactical font-bold uppercase tracking-widest text-xs mb-2">Assinatura Premium</h3>
                <p className="text-theme-text-muted text-sm font-normal leading-relaxed">Plano mensal de impressão e entrega das fotos mais votadas</p>
              </div>
            </div>
          </section>
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-8">
            <section className="bg-theme-bg-muted p-3 md:p-6 rounded-2xl border border-theme-border">
              ...
              <ul className="space-y-4 text-theme-text-muted text-sm font-normal">
                <li className="flex gap-3"><span className="text-brand-tactical font-bold">3.1</span> Para utilizar a Plataforma, é necessário criar uma conta com informações verdadeiras e atualizadas.</li>
                <li className="flex gap-3"><span className="text-brand-tactical font-bold">3.2</span> Você é responsável pela confidencialidade da sua senha e por todas as atividades realizadas em sua conta.</li>
                <li className="flex gap-3"><span className="text-brand-tactical font-bold">3.3</span> A Foto Segundo reserva-se o direito de suspender ou encerrar contas que violem estes Termos.</li>
              </ul>
            </section>
            ...
            <section className="bg-theme-bg-muted p-3 md:p-6 rounded-2xl border border-theme-border">
              ...
              <ul className="space-y-4 text-theme-text-muted text-sm font-normal">
                <li className="flex gap-3"><span className="text-brand-tactical font-bold">5.1</span> Os pagamentos são processados via Mercado Pago, com suporte a PIX e cartão de crédito.</li>
                <li className="flex gap-3"><span className="text-brand-tactical font-bold">5.2</span> O agendamento de eventos exige pagamento de 50% no ato da reserva e 50% até 56 horas antes do evento.</li>
                <li className="flex gap-3"><span className="text-brand-tactical font-bold">5.3</span> Cancelamentos &gt;72 horas: reembolso integral. Cancelamentos {'<'}72 horas: retenção do sinal de 50%.</li>
                <li className="flex gap-3"><span className="text-brand-tactical font-bold">5.4</span> Assinaturas podem ser canceladas a qualquer momento.</li>
              </ul>
            </section>
          </div>
