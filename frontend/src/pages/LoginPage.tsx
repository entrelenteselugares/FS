    ...
    <div className="h-screen flex flex-col lg:flex-row overflow-hidden bg-theme-bg">
      ...
      <div className="flex flex-none h-[30vh] lg:h-auto lg:flex-1 relative overflow-hidden">
        ...
        <div className="absolute bottom-8 left-8 z-20 hidden lg:block">
          <p className="text-[9px] font-bold uppercase tracking-[0.4em] text-theme-text/30">
            Cada segundo conta.
          </p>
        </div>
      ...
      >
        ...
        <div className="flex-1 flex flex-col justify-center px-3 md:px-6 md:px-10 xl:px-14 py-3 md:py-6 md:py-12 space-y-10">
          ...
          {/* Error */}
          {error && (
            <div className="bg-brand-danger/10 text-brand-danger text-[9px] font-bold uppercase tracking-[0.2em] p-4 text-center border border-brand-danger/20 rounded-xl">
              {error}
            </div>
          )}
          ...
          <div className="space-y-5">
            <div className="space-y-3">
              <Button 
                ...
                variant="secondary"
                fullWidth
                className="bg-white text-gray-800 hover:text-gray-900 hover:bg-gray-100 border-gray-300 h-12 flex items-center justify-center relative"
              >
