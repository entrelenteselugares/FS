      ...
      <main className="pt-32 pb-24 px-3 md:px-6 md:px-8 max-w-4xl mx-auto">
        <div className="mb-16 md:mb-24 text-center max-w-3xl mx-auto">
          <div className="flex items-center justify-center gap-4 mb-6">
            ...
            <span className="text-[10px] font-bold text-brand-tactical uppercase tracking-[0.5em]">Comunicação Direta</span>
            <div className="h-px w-12 bg-brand-tactical" />
          </div>
          ...
          <p className="text-theme-text-muted font-normal text-base md:text-lg leading-relaxed max-w-xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-3 md:gap-6 mb-16">
          ...
          <div className="bg-theme-bg-muted border border-theme-border p-4 md:p-8 rounded-3xl hover:border-brand-tactical/50 transition-colors">
            ...
            <h2 className="text-xl font-bold uppercase mb-3">Suporte ao Cliente</h2>
            ...
            <div className="pt-6 border-t border-theme-border">
              <p className="text-xs font-normal text-theme-text-muted leading-relaxed">
          ...
          <div className="bg-theme-bg-muted border border-theme-border p-4 md:p-8 rounded-3xl hover:border-brand-tactical/50 transition-colors">
            ...
            <h2 className="text-xl font-bold uppercase mb-3">Parcerias B2B</h2>
            <p className="text-theme-text-muted text-sm font-normal leading-relaxed mb-6">
            ...
            <div className="pt-6 border-t border-theme-border">
              <Link to="/parcerias" className="text-xs font-bold uppercase tracking-widest text-brand-tactical hover:brightness-110 flex items-center gap-2">
          ...
          <div className="bg-theme-bg-muted border border-theme-border p-4 md:p-8 rounded-3xl hover:border-brand-tactical/50 transition-colors">
            ...
            <h2 className="text-xl font-bold uppercase mb-3">Profissionais da Rede</h2>
            <p className="text-theme-text-muted text-sm font-normal leading-relaxed mb-6">
            ...
            <p className="text-xs text-theme-text-muted font-normal">Assunto sugerido: <strong className="text-theme-text">&quot;Quero ser profissional da rede&quot;</strong> (Não esqueça o portfólio!)</p>
          </div>
          ...
          <div className="bg-theme-bg-muted border border-theme-border p-4 md:p-8 rounded-3xl hover:border-brand-tactical/50 transition-colors">
            ...
            <h2 className="text-xl font-bold uppercase mb-3">Imprensa</h2>
            <p className="text-theme-text-muted text-sm font-normal leading-relaxed mb-6">
          ...
          <div className="bg-theme-bg-muted border border-theme-border p-4 md:p-8 rounded-3xl hover:border-brand-tactical/50 transition-colors">
            ...
            <h2 className="text-xl font-bold uppercase mb-3">Privacidade e LGPD</h2>
            <p className="text-theme-text-muted text-sm font-normal leading-relaxed mb-6">
            ...
            <div className="pt-6 border-t border-theme-border">
              <Link to="/privacidade" className="text-xs font-bold uppercase tracking-widest text-brand-tactical hover:brightness-110 flex items-center gap-2">
          ...
          <div className="bg-theme-bg-muted border border-theme-border p-4 md:p-8 rounded-3xl hover:border-brand-tactical/50 transition-colors flex flex-col justify-between">
            <div>
              ...
              <h2 className="text-xl font-bold uppercase mb-3">Status da Plataforma</h2>
              <p className="text-theme-text-muted text-sm font-normal leading-relaxed mb-6">
                Para verificar se há instabilidades em andamento nos serviços ou uploads.
              </p>
            </div>
            <div className="pt-6 border-t border-theme-border">
              <Link to="/status" className="text-xs font-bold uppercase tracking-widest text-brand-tactical hover:brightness-110 flex items-center gap-2">
        ...
        <div className="mt-16 text-center border-t border-theme-border pt-16">
          ...
          <h2 className="text-2xl font-bold uppercase mb-2">Sede</h2>
          <p className="text-theme-text font-medium text-lg uppercase tracking-widest mb-1">Foto Segundo</p>
          <p className="text-theme-text-muted font-normal mb-4">Sumaré, São Paulo — Brasil</p>
