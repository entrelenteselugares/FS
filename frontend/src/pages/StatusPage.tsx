      ...
      <main className="pt-32 pb-24 px-6 md:px-8 max-w-4xl mx-auto">
        <div className="mb-16 md:mb-20 text-center max-w-3xl mx-auto">
          ...
          <div className="bg-emerald-500/5 border border-emerald-500/30 p-8 rounded-3xl flex flex-col items-center">
            ...
            <h2 className="text-2xl font-black text-emerald-500 uppercase tracking-widest mb-2">
              Todos os sistemas operando normalmente
            </h2>
            <p className="text-theme-text-muted text-sm font-light uppercase tracking-widest">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <section className="bg-brand-tactical/10 border border-brand-tactical/20 p-8 rounded-3xl">
            ...
            <p className="text-theme-text-muted text-sm font-light leading-relaxed mb-4">
            ...
            <ul className="space-y-3 mb-6 text-sm text-theme-text-muted font-light">
          ...
          <section className="bg-theme-bg-muted border border-theme-border p-8 rounded-3xl flex flex-col justify-between">
            ...
            <Link to="/contato" className="inline-flex items-center gap-2 text-brand-tactical font-black uppercase tracking-widest text-xs hover:underline">
