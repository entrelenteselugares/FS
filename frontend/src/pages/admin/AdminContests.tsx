        ...
        <div className="flex flex-col xl:flex-row justify-between items-start xl:items-end gap-3 md:gap-6 relative z-10">
          ...
          <div className="flex flex-wrap items-center gap-4 w-full xl:w-auto">
            <button 
              ...
              className="flex-1 md:flex-none px-4 md:px-8 py-4 bg-brand-tactical text-zinc-950 text-[10px] font-bold uppercase tracking-[0.4em] hover:brightness-110 shadow-xl transition-all text-center w-full break-words leading-tight"
            >
              NOVO CONCURSO
            </button>
          </div>
          ...
          <div className="relative w-full max-w-2xl bg-theme-card border border-theme-border rounded-[40px] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300 flex flex-col h-[90vh]">
            ...
            <div className="p-4 md:p-8 md:p-10 border-b border-theme-border flex items-center justify-between shrink-0 bg-theme-bg-muted rounded-2xl">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold uppercase text-theme-text">{editingContest ? "Ajustar Campanha" : "Engenharia de Concurso"}</h2>
                  <p className="text-[10px] font-bold uppercase tracking-[0.2em] opacity-40">{editingContest ? "Atualização de Regras e Premiações" : "Motor de Gamificação e Engajamento Viral"}</p>
                </div>
              </div>
                ...
                {dynamicType !== 'CITY_EVENT' && dynamicType !== 'CUSTOM' && (
                  <div className="space-y-2">
                    ...
                    <input 
                      type="number" 
                      required 
                      className="w-full bg-transparent border-b border-brand-tactical/40 p-4 text-3xl font-bold text-brand-tactical outline-none focus:border-brand-tactical" 
                      value={dynamicTarget} 
