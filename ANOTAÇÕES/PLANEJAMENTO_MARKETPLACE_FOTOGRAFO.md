...
- **Módulo de Venda Expressa (CONCLUÍDO ✅)**:
  - Disponível no topo do dashboard do fotógrafo.
  - **Lead CRM**: Captura de WhatsApp e Notas Internas integrada.
  - **Automação**: Ao registrar uma venda (E-mail + Pack de Fotos), o sistema cria o evento, gera o pedido e notifica o editor.
  - **Privacidade**: Início automático em modo privado para proteção do cliente.
