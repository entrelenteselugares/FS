...
- **Persistência de Carrinho:** Armazenamento local (IndexedDB/localStorage) sincronizado com o banco (`Order` PENDENTE) garantindo que o carrinho sobreviva a *app kills*.
