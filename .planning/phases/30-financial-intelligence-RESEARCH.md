...
- **Por que:** É uma biblioteca madura, leve (ideal para Vercel Serverless) e permite controle total sobre o layout (coordenadas absolutas), essencial para manter a estética *Midnight Luxury*.
