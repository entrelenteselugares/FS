...
- **Active Role**: The `user.role` field in the database acts as the *primary/active* role, but we'll introduce logic to allow switching if the secondary profiles exist.
