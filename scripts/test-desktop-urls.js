...
const REPORT_FILE = path.join(MANUAIS_DIR, 'RELATORIO-ERROS-DESKTOP.md');
...
async function run() {
  console.log('🚀 Starting Desktop URL Testing...');
  ...
  if (failed.length > 0) {
    ...
    report += `## 🎉 Todas as URLs carregaram com sucesso no formato desktop\n`;
  }
  
  fs.writeFileSync(REPORT_FILE, report);
  console.log(`\n🎉 Desktop URLs testing completed! Report saved to: ${REPORT_FILE}`);
}
