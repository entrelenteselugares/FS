...
async function runOnboarding(page: Page, role: 'CLIENTE' | 'PROFISSIONAL' | 'CARTORIO') {
  ...
  if (role === 'PROFISSIONAL') {
    await expect(page.getByText(/Meu Cockpit|Venda Rápida/i).first()).toBeVisible();
