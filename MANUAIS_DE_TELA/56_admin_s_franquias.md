# Manual de Tela — **Admin: Franquias** — Gestão de franqueados

## ℹ️ Informações Gerais

- **URL:** `/admin?s=franquias`
- **Caminho Resolvido:** `/admin/franchises`
- **Nível de Acesso:** `ADMIN`
- **Título da Página (HTML):** `Foto Segundo | Suas memórias, entregues agora.`

## 📸 Captura da Tela

![Screenshot de **Admin: Franquias** — Gestão de franqueados](./screenshots/56_admin_s_franquias.png)
