# Manual de Tela — **Vitrine de Profissionais** — Galeria de fotógrafos da plataforma

## ℹ️ Informações Gerais

- **URL:** `/vitrine`
- **Caminho Resolvido:** `/vitrine`
- **Nível de Acesso:** `Todos`
- **Título da Página (HTML):** `Foto Segundo | Suas memórias, entregues agora.`

## 📸 Captura da Tela

![Screenshot de **Vitrine de Profissionais** — Galeria de fotógrafos da plataforma](./screenshots/06_vitrine.png)
