...
- **URL:** `/minha-conta?s=affiliate`
- **Caminho Resolvido:** `/minha-conta?s=affiliate`
- **Nível de Acesso:** `Autenticado`
- **Título da Página (HTML):** `Foto Segundo | Suas memórias, entregues agora.`

## 📸 Captura da Tela

![Screenshot de **Aba: Afiliado** — Programa de indicação](./screenshots/34_minha_conta_s_affiliate.png)
