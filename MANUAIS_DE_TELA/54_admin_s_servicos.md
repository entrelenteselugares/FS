# Manual de Tela — **Admin: Serviços** — Catálogo de serviços da plataforma

## ℹ️ Informações Gerais

- **URL:** `/admin?s=servicos`
- **Caminho Resolvido:** `/admin/services`
- **Nível de Acesso:** `ADMIN`
- **Título da Página (HTML):** `Foto Segundo | Suas memórias, entregues agora.`

## 📸 Captura da Tela

![Screenshot de **Admin: Serviços** — Catálogo de serviços da plataforma](./screenshots/54_admin_s_servicos.png)
...
- **Botão:** `CATÁLOGO GLOBAL`
- **Botão:** `PACOTES (COMBOS)`
