# Manual de Tela — **Admin: Unidades** — Casas parceiras cadastradas

## ℹ️ Informações Gerais

- **URL:** `/admin?s=unidades`
...
![Screenshot de **Admin: Unidades** — Casas parceiras cadastradas](./screenshots/55_admin_s_unidades.png)
