# Manual de Tela — **Admin: Financeiro** — Pagamentos e repasses

## ℹ️ Informações Gerais

- **URL:** `/admin?s=financeiro`
- **Caminho Resolvido:** `/admin/finance`
- **Nível de Acesso:** `ADMIN`
- **Título da Página (HTML):** `Foto Segundo | Suas memórias, entregues agora.`

## 📸 Captura da Tela

![Screenshot de **Admin: Financeiro** — Pagamentos e repasses](./screenshots/52_admin_s_financeiro.png)
