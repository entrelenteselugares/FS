# Manual de Tela — **Redirect Inteligente** — Redireciona para o painel correto do role

## ℹ️ Informações Gerais

- **URL:** `/dashboard`
- **Caminho Resolvido:** `/dashboard`
- **Nível de Acesso:** `Autenticado`
- **Título da Página (HTML):** `Foto Segundo | Suas memórias, entregues agora.`

## 📸 Captura da Tela

![Screenshot de **Redirect Inteligente** — Redireciona para o painel correto do role](./screenshots/74_dashboard.png)
