# Manual de Tela — **Captura Phygital** — Alias de /captura

## ℹ️ Informações Gerais

- **URL:** `/phygital-capture`
- **Caminho Resolvido:** `/phygital-capture`
- **Nível de Acesso:** `PROFISSIONAL`
- **Título da Página (HTML):** `Foto Segundo | Suas memórias, entregues agora.`

## 📸 Captura da Tela

![Screenshot de **Captura Phygital** — Alias de /captura](./screenshots/70_phygital_capture.png)
