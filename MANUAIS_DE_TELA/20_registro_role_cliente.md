# Manual de Tela — **Cadastro** — Criação de conta (Modalidade Cliente)

## ℹ️ Informações Gerais

- **URL:** `/registro?role=CLIENTE`
- **Caminho Resolvido:** `/registro?role=CLIENTE`
- **Nível de Acesso:** `Público`
- **Título da Página (HTML):** `Registro — Foto Segundo`

## 📸 Captura da Tela

![Screenshot de **Cadastro** — Criação de conta (Modalidade Cliente)](./screenshots/20_registro_role_cliente.png)
