# Manual de Tela — **Admin: Unidades/Fornecedores** — Gestão de impressão
...
![Screenshot de **Admin: Unidades/Fornecedores** — Gestão de impressão](./screenshots/55_admin_printers.png)
