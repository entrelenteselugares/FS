...
| **Cartório**  | Login B2B → Tabela de Preços Ativa → Visualização de Split | ✅ **Passou**              | Repasse da taxa passiva calculado corretamente usando base dinâmica, provando a robustez da _residual claimant_ da Matriz.                                                                     |
